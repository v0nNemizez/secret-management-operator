...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RaftSettings) DeepCopyInto(out *RaftSettings) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RaftSettings.
func (in *RaftSettings) DeepCopy() *RaftSettings {
	if in == nil {
		return nil
	}
	out := new(RaftSettings)
	in.DeepCopyInto(out)
	return out
}
